...
const Home = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-beige-50 via-amber-50 to-yellow-50">
     {/* Navbar */}
<nav className="flex justify-between items-center px-6 py-4 bg-white/90 backdrop-blur-md shadow-lg sticky top-0 z-50 rounded-b-xl transition-all duration-500 hover:shadow-2xl max-w-7xl mx-auto w-full">
